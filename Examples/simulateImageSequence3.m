...
% Noise parameters:
shot_noise_factor = 0; % For noise which depends on intensity, for shot-noise: proportional to square root of number of photons/intensity. (Default = 1).
...
%     shot_noise_factor*sqrt(padded_image).*rand(frame_size,frame_size);
